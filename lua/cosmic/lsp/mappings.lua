...
function M.init(client, bufnr)
  ...
  buf_map(bufnr, 'n', '<M-d>', '<cmd>lua require("telescope.builtin").lsp_definitions()<cr>')
  ...
  buf_map(bufnr, 'n', '<M-r>', '<cmd>lua require("telescope.builtin").lsp_references()<cr>')
  ...
  -- hover
  buf_map(bufnr, 'n', '<M-h>', '<cmd>lua vim.lsp.buf.hover()<cr>')
  ...
  buf_map(bufnr, 'n', '<M-u>', '<cmd>lua vim.lsp.buf.formatting()<cr>')
  -- buf_map(bufnr, 'v', '<leader>gf', '<cmd>lua vim.lsp.buf.range_formatting()<cr>')

  -- signature help
  buf_map(bufnr, 'n', '<m-h>', '<cmd>lua require("lsp_signature").signature()<cr>')
